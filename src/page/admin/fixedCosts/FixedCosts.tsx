...
const FixedCosts = () => {
  ...
  const handelFetchData = async () => {
    try {
      const { data } = await axios.get(
        "http://103.245.237.93:8082/api/LossCostVehicle/lossCostCar/vehicleId/startDate/endDate",
        {
          headers: {
  ...
  const confirm = async (e) => {
    try {
      await axios.delete(
        `http://103.245.237.93:8082/api/LossCostVehicle/deleteLossCost/id?id=${e}`,
        {
          headers: {
            Authorization: "Bearer " + checkLoginToken(),
          },
    ...
    try {
        if(idUser){
            const payload = {
              ...
              const url = idUser
                ? `http://103.245.237.93:8082/api/LossCostVehicle/updateLossCost/id?id=${idUser.lossCostTypeId}`
                : `http://103.245.237.93:8082/api/LossCostVehicle/addLossCostVehicle`;
            ...
            const payload = {
              ...
              const url =  `http://103.245.237.93:8082/api/LossCostVehicle/addLossCostVehicle`;
